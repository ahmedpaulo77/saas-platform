...
export default function Reports() {
  ...
  const statCards = ALL_STAT_CARDS.filter((s) =>
    availableModules.has(s.module),
  );
              ...
              <div className="card">
                ...
                <div
                  style={{
                    ...
                    marginBottom: 8,
                    background:
                      stats.lowStockProducts > 0 ? "#fef2f2" : "#f0fdf4",
                  ...
                  >
                    <span
                      style={{
                        ...
                        fontWeight: 600,
                        color:
                          stats.lowStockProducts > 0 ? "#dc2626" : "#16a34a",
                      }}
                    >
                      {stats.lowStockProducts > 0
                        ? t("rep.lowStock").replace(
                            "{n}",
                ...
                {lowStock.slice(0, 4).map((p) => (
                  ...
                  >
                    ...
                    <span className="badge badge-expired">
                      {t("rep.left").replace("{n}", p.quantity)}
                    </span>{" "}
                  </div>
                ))}
              </div>
