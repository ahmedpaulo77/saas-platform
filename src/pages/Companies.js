...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    async function fetchStats() {
      ...
      try {
        // ✅ إصلاح: كانت بتستخدم query(where('__name__','==',...)) وده
        // بيتحسب "list" في الـ Rules، ورولز companies بقت list: isSuperAdmin() بس.
        // فأي أدمن/موظف عادي كان بيترفض هنا، وبما إن كله في Promise.all واحد،
        // فشل واحد كان بيصفّر كل الأرقام مع بعض. getDoc بيتحقق بـ "get" مش "list"،
        // والـ get مفتوح لأي مسجل دخول.
        const [
          compExists,
          cliSnap,
          sellerSnap,
