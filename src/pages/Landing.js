...
const features = [
  {
    ...
    color: "#6366f1",
    bg: "#eef2ff",
    titleKey: "landing.f1.t",
    descKey: "landing.f1.d",
  },
  {
    icon: "fas fa-user-friends",
    color: "#10b981",
    bg: "#d1fae5",
    titleKey: "landing.f2.t",
    descKey: "landing.f2.d",
  },
  {
    icon: "fas fa-file-invoice",
    color: "#f59e0b",
    bg: "#fef3c7",
    titleKey: "landing.f3.t",
    descKey: "landing.f3.d",
  },
  {
    icon: "fas fa-boxes",
    color: "#8b5cf6",
    bg: "#f3e8ff",
    titleKey: "landing.f4.t",
    descKey: "landing.f4.d",
  },
  {
    icon: "fas fa-tasks",
    color: "#ec4899",
    bg: "#fdf2f8",
    titleKey: "landing.f5.t",
    descKey: "landing.f5.d",
  },
  {
    icon: "fas fa-chart-pie",
    color: "#06b6d4",
    bg: "#ecfeff",
    titleKey: "landing.f6.t",
    descKey: "landing.f6.d",
  },
  {
    icon: "fas fa-bell",
    color: "#f97316",
    bg: "#fff7ed",
    titleKey: "landing.f7.t",
    descKey: "landing.f7.d",
  },
  {
    icon: "fas fa-rocket",
    color: "#eab308",
    bg: "#fefce8",
    titleKey: "landing.f8.t",
    descKey: "landing.f8.d",
  },
  {
    icon: "fas fa-shield-alt",
    color: "#14b8a6",
    bg: "#f0fdfa",
    titleKey: "landing.f9.t",
    descKey: "landing.f9.d",
  },
];
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 800 }}>
          ...
          >
            <i
              ...
              style={{ color: "#10b981", marginLeft: 6 }}
            ></i>
            {t("landing.trialNote")}
          </p>
        </div>
